...
//==== hbs =====//
const menuMarkup = (0, _menuJsonDefault.default).map(({ image , name , price , description , ingredients  })=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/menu.json":"1X6X1"}],"gkKU3":[function(require,module,exports) {
